...
export default function NewReservation({ loadDashboard, edit }) {
  ...
  /**
   * Make API call to get all reservations if editing/ filling in the form
   */
  useEffect(() => {
    if (edit) {
  ...
  /**
   * Whenever the user makes a change to form, update the state
   */
  ...
  /**
   * Whenever the user submits the form, validate and make the API call.
   */
  ...
  /**
   * Make sure all fields exist and filled in correctly
   */
